...
import numpy as np
import math
from data_utils import GetFileFromThisRootDir
import cv2
...
if __name__ == '__main__':
    ...
    a = os.path.join(filedir, '..', 'dataset', 'train'),
    split = splitbase(os.path.join(filedir, 'RSOC_small-vehicle', 'train'),
                      os.path.join(filedir, 'RSOC_small-vehicle', 'train_split'),
                      gap=200,
                      subsize=1024,
                      num_process=8
                      )
    ...
    split = splitbase(os.path.join(filedir, 'RSOC_small-vehicle', 'val'),
                      os.path.join(filedir, 'RSOC_small-vehicle', 'val_split'),
                      gap=200,
                      subsize=1024,
                      num_process=8
                      )
